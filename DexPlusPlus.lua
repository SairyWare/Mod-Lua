			...
			for _,node in next, sList do
				...
				if Obj:IsA("BasePart") then
					if Obj.CanCollide then
						...
						plrRP.CFrame = CFrame.new(Obj.Position + (Settings.Explorer.TeleportToOffset or Vector3.zero))
					end
					break
				elseif Obj:IsA("Model") then
					if Obj.PrimaryPart then
						if Obj.PrimaryPart.CanCollide then
							...
							plrRP.CFrame = CFrame.new(Obj.PrimaryPart.Position + (Settings.Explorer.TeleportToOffset or Vector3.zero))
						end
						break
					else
						...
						if part and nodes[part] then
							if part.CanCollide then
								...
								plrRP.CFrame = CFrame.new(part.Position + (Settings.Explorer.TeleportToOffset or Vector3.zero))
							end
							break
